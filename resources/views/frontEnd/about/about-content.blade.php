        ...
        <div class="privacy about">
            ...
            <div class="agile_about_grids">
                <div class="col-md-6 agile_about_grid_right">
                    <img src="{{asset('/frontEndAssets/')}}/images/31.jpg" alt=" " class="img-responsive" />
                </div>
        ...
        <div class="container">
            ...
            <div class="agileits_team_grids">
                <div class="col-md-3 agileits_team_grid">
                    <img src="{{asset('/frontEndAssets/')}}/images/32.jpg" alt=" " class="img-responsive" />
                    <h4>Martin Paul</h4>
                    <p>Manager</p>
                ...
                <div class="col-md-3 agileits_team_grid">
                    <img src="{{asset('/frontEndAssets/')}}/images/33.jpg" alt=" " class="img-responsive" />
                    <h4>Michael Rick</h4>
                    <p>Supervisor</p>
                    <ul class="agileits_social_icons agileits_social_icons_team">
                        <li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                ...
                <div class="col-md-3 agileits_team_grid">
                    <img src="{{asset('/frontEndAssets/')}}/images/34.jpg" alt=" " class="img-responsive" />
                    <h4>Thomas Carl</h4>
                    <p>Supervisor</p>
                    <ul class="agileits_social_icons agileits_social_icons_team">
                        <li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                ...
                <div class="col-md-3 agileits_team_grid">
                    <img src="{{asset('/frontEndAssets/')}}/images/35.jpg" alt=" " class="img-responsive" />
                    <h4>Laura Lee</h4>
                    <p>CEO</p>
                    <ul class="agileits_social_icons agileits_social_icons_team">
                        <li><a href="#" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
    ...
    <div class="testimonials">
        <div class="container">
            ...
            <div class="w3_testimonials_grids">
                ...
                <script src="{{asset('/frontEndAssets/')}}/js/jquery.wmuSlider.js"></script>
                <script>
                    $('.example1').wmuSlider();
                </script>
            </div>
